...
class Transformer(nn.Module):
    ...
    def __init__(self, conf):
        ...
        encoder_layer = TransformerEncoderLayer(
            ...
            self.dropout, self.activation, self.pre_norm
        )
        ...
        self.decoder_interaction = TransformerDecoder(
            decoder_layer_interaction, self.num_decoder_layers_interaction, decoder_norm_interaction
        )
    ...
    def forward(self, src, mask, query_embed, pos_embed, embed_dict=None, targets=None, cur_idx=0):
        ...
        interaction_out = self.decoder_interaction(
            hopd_out, memory, memory_key_padding_mask=mask,
            pos=pos_embed, query_pos=query_embed
        )
