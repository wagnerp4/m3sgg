...
class COCO:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            ...
            dataset = json.load(
                open(
                    "/home/cong/Dokumente/dynamicSG/preprocessing/result/ag_databset.json",
                    "r",
                )
            )
            assert (
    ...
    def loadRes(self, resFile):
        ...
        with open(
            "/home/cong/Dokumente/dynamicSG/preprocessing/result/ag_database_testimage.pkl",
            "rb",
        ) as f:
        ...
        if type(resFile) == str or (
            PYTHON_VERSION == 2 and type(resFile).__name__ == "unicode"
        ):
