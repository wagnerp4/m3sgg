...
def dataset():
    ...
    class MockDataset:
        def __init__(self):
            ...
            self.spatial_relationships = ["above", "below", "left_of", "right_of", "near", "far"]
            self.contacting_relationships = ["touching", "holding", "carrying", "pushing", "pulling", "sitting_on", "standing_on", "lying_on", "riding", "wearing", "eating", "drinking", "using", "playing_with", "opening", "closing", "cleaning"]
            self.relationship_classes = self.attention_relationships + self.spatial_relationships + self.contacting_relationships
