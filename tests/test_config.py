...
TEST_CONFIG: Dict[str, Any] = {
    ...
    "timeout": {"unit": 30, "integration": 300, "performance": 600},
    "memory_limit": "2GB",
    "gpu_required": False,
}
...
def setup_test_environment():
    ...
    os.environ["PYTHONPATH"] = (
        f"{project_root}{os.pathsep}{project_root / 'src'}{os.pathsep}{os.environ.get('PYTHONPATH', '')}"
    )
    os.environ["M3SGG_TEST_MODE"] = "true"
    os.environ["CUDA_VISIBLE_DEVICES"] = (
        ""  # Disable GPU for tests unless explicitly needed
    )
