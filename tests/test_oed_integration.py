    ...
    try:
        ...
        class MockDataset:
            def __init__(self):
                ...
                self.spatial_relationships = ["above", "below", "left", "right", "inside", "outside"]
...
def test_oed_forward_pass():
    ...
    try:
        ...
        with torch.no_grad():
            ...
            print(f"  Attention distribution shape: {output['attention_distribution'].shape}")
...
def test_oed_criterion():
    ...
    try:
        ...
        criterion = SetCriterionOED(
            ...
            eos_coef=0.1,
            losses=['obj_labels', 'boxes', 'attn_labels', 'spatial_labels', 'contacting_labels'],
            conf=mock_conf
        )
