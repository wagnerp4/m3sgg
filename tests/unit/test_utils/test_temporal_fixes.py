...
def test_tensor_handling():
    ...
    # Verify the data structures are properly populated
    assert len(temporal_frames) == 3
    assert len(temporal_entries) == 3
    assert len(temporal_preds) == 3
    assert len(temporal_im_infos) == 3
