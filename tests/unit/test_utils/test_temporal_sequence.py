...
def test_temporal_sequence():
    ...
    assert len(temporal_frames) == max_temporal_frames
    assert len(temporal_entries) == max_temporal_frames
    assert len(temporal_preds) == max_temporal_frames
    assert len(temporal_im_infos) == max_temporal_frames
