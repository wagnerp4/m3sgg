...
def test_command(stage_name, description):
    ...
    sys.argv = [
        ...
        '-model', 'scenellm', 
        '-scenellm_training_stage', stage_name, 
        '-nepoch', '2'
    ]
    
    try:
        conf = Config()
        print(f"Command: python train.py -mode predcls -dataset action_genome -data_path data/action_genome -model scenellm -scenellm_training_stage {stage_name} -nepoch 2")
...
if __name__ == "__main__":
    ...
    if all_passed:
        ...
        print("• python train.py -mode predcls -dataset action_genome -data_path data/action_genome -model scenellm -scenellm_training_stage vqvae -nepoch 2")
        print("• python train.py -mode predcls -dataset action_genome -data_path data/action_genome -model scenellm -scenellm_training_stage stage1 -nepoch 2")
        print("• python train.py -mode predcls -dataset action_genome -data_path data/action_genome -model scenellm -scenellm_training_stage stage2 -nepoch 2")
    else:
