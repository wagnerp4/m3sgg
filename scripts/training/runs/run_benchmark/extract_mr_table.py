...
def extract_final_metrics_from_log(log_file):
    ...
    metrics = {
        'R@10': 0, 'R@20': 0, 'R@50': 0, 'R@100': 0,
        'MR@10': 0, 'MR@20': 0, 'MR@50': 0, 'MR@100': 0
    }
        ...
        for mode in modes:
            ...
            if os.path.exists(log_file):
                ...
                table_data.append({
                    'Model': model.upper(),
                    'Mode': mode,
                    'R@10': 'N/A', 'R@20': 'N/A', 'R@50': 'N/A', 'R@100': 'N/A',
                    'MR@10': 'N/A', 'MR@20': 'N/A', 'MR@50': 'N/A', 'MR@100': 'N/A'
                })
...
def main():
    ...
    numeric_cols = ['R@10', 'R@20', 'R@50', 'R@100', 'MR@10', 'MR@20', 'MR@50', 'MR@100']
