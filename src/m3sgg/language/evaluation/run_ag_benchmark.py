...
def setup_logging(
    log_file: str = "data/summarization/ag_benchmark.log", verbose: bool = False
):
...
def main():
    ...
    # Benchmark arguments
    parser.add_argument(
        "--subset-size", type=int, default=100, help="Number of samples to evaluate"
    )
    parser.add_argument(
    ...
    try:
        ...
        benchmark = ActionGenomeSummarizationBenchmark(
            data_path=args.data_path, device=args.device, split=args.split
        )
