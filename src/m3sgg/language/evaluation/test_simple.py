...
def main():
    ...
    if passed == total:
        ...
        print("\nNext steps:")
        print("1. Install dependencies: pip install -r lib/language/evaluation/requirements.txt")
        print("2. Run full test: python lib/language/evaluation/test_evaluation.py")
        print("3. Run benchmark: python lib/language/evaluation/run_benchmark.py --checkpoint <path>")
    else:
