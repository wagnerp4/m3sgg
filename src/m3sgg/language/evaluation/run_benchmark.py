...
def main():
    ...
    parser.add_argument("--output", default="data/summarization/summarization_benchmark_results.json",
    ...
    parser.add_argument("--video-root", default="data/msr_vtt/videos",
                       help="Root directory containing MSR-VTT video files")
    parser.add_argument("--sg-cache-dir", default="data/summarization/cache",
    ...
    parser.add_argument("--linearizer", choices=["flat", "majority", "time"], default="flat",
                       help="Linearization strategy for scene graphs")
    parser.add_argument("--variant", choices=["sg", "no_sg", "caption_input"], default="sg",
                       help="Input variant: use scene graph, empty input, or reference caption as input")
    parser.add_argument("--linearizers", nargs="+", default=None,
