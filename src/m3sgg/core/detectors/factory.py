...
class DetectorFactory:
    ...
    def _create_vit_detector(self) -> torch.nn.Module:
        ...
        try:
            ...
            self.logger.info(
                f"Created ViT detector with backbone: {self.config.vit_backbone}"
            )
            detector.eval()
            return detector
        except ImportError:
    ...
    def _create_detr_detector(self) -> torch.nn.Module:
        ...
        try:
            ...
            self.logger.info(
                f"Created DETR detector with backbone: {self.config.detr_backbone}"
            )
            detector.eval()
            return detector
        except ImportError:
    ...
    def _create_yolo_detector(self) -> torch.nn.Module:
        ...
        try:
            ...
            self.logger.info(
                f"Created YOLO detector with model size: {self.config.yolo_model_size}"
            )
            detector.eval()
            return detector
        except ImportError:
    ...
    def _create_resnet_detector(self) -> torch.nn.Module:
        ...
        try:
            ...
            self.logger.info(
                f"Created ResNet detector with backbone: {self.config.resnet_backbone}"
            )
            detector.eval()
            return detector
        except ImportError:
