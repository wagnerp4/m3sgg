...
def main():
    ...
    example_scene_graph = {
        ...
        "frame_objects": [
            ...
            [{"object_name": "person", "confidence": 0.93}, {"object_name": "laptop", "confidence": 0.79}],
            [{"object_name": "person", "confidence": 0.90}, {"object_name": "book", "confidence": 0.82}],
        ...
        "frame_relationships": [
            ...
            [],
            [],
            [{"subject_class": "person", "object_class": "laptop", "predicate": "using", "confidence": 0.85}],
            [{"subject_class": "person", "object_class": "book", "predicate": "reading", "confidence": 0.78}],
            [],
            []
        ]
    }
